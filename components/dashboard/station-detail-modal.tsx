...
export function StationDetailModal({ station, isOpen, onClose }: StationDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex z-10000 items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-slate-900 rounded-xl w-full max-w-5xl h-[85vh] sm:h-[80vh] flex flex-col shadow-2xl border border-slate-700">
        {/* Fixed Header */}
        <div className="flex items-start justify-between p-3 sm:p-4 border-b border-slate-700 bg-slate-900 rounded-t-xl flex-shrink-0">
